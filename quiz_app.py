...
# Helper function to move between quiz pages
...
if st.session_state.step == 1:
    ...
    # Mapping user choices to data categories
...
# STEP 4: RECOMMENDATION ENGINE OUTPUT
    ...
    # Filter 3: Ingredient Layer Matching (Searches across Top, Heart, and Base notes)
    ...
    # Fallback mechanism if constraints are too tight
